...
internal static class DisplayHelper
{
    ...
    public static string GetServiceName(GattDeviceService service)
    {
        ...
        {
            var id = ConvertUuidToShortId(service.Uuid);
            if (Enum.IsDefined(typeof(GattNativeServiceUuid), id))
            {
                return ((GattNativeServiceUuid)id).ToString();
            }
        }
        return "(Custom)";
    }
    ...
    public static string GetCharacteristicName(GattCharacteristic characteristic)
    {
        ...
        {
            var id = ConvertUuidToShortId(characteristic.Uuid);
            if (Enum.IsDefined(typeof(GattNativeCharacteristicUuid), id))
            {
